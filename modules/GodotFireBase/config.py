...
def configure(env):
    ...
    if env["platform"] == "android":
        ...
        env.android_add_dependency(implement("com.google.firebase:firebase-analytics:18.0.1"))
        if _config["Auth"]:
        ...
        if _config["Notification"]:
            env.android_add_dependency(implement("com.google.firebase:firebase-messaging:20.2.0"))
